...
Esse projeto tem o intuito de demonstrar a contrução da automação de testes com o foco em boas práticas de arquitetura de testes, organização do código e seguraça do processo.
